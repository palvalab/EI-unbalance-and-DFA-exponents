function h = raincloud_plot_color(X,yaxis_val,cl)

% % % [a,b] = ksdensity(X);
% % % 
wdth = 2; % width of boxplot
...
% mean line
h{3} = line([Y(3) Y(3)],[-1-(wdth*yl(2)/2) (-1-(wdth*yl(2)/2) +wdth)],'col','k','LineWidth',1.5);

% whiskers
h{4} = line([Y(2) Y(5)], [(-1-(wdth*yl(2)/2) +wdth/2) (-1-(wdth*yl(2)/2) +wdth/2)],'col','k','LineWidth',1.5);
h{5} = line([Y(1) Y(4)],[(-1-(wdth*yl(2)/2) +wdth/2) (-1-(wdth*yl(2)/2) +wdth/2)],'col','k','LineWidth',1.5);
h{6} = line([Y(4) Y(4)],[-1-(wdth*yl(2)/2) (-1-(wdth*yl(2)/2) +wdth)],'col','k','LineWidth',1.5);
h{7} = line([Y(5) Y(5)],[-1-(wdth*yl(2)/2) (-1-(wdth*yl(2)/2) +wdth)],'col','k','LineWidth',1.5);
